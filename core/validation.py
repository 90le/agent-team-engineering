...
REQUIRED_PATHS = (
    ...
    "core/native_scenario.py",
    "core/reference_adapters.py",
    "core/runner_conformance.py",
    "core/github_scm.py",
    "core/guided_adoption.py",
    "core/host_catalog.py",
    "core/host_lifecycle.py",
    "core/external_projections.py",
    ...
    "adapters/native-oci/adapter.json",
    "adapters/native-oci/descriptor.json",
    "adapters/swe-rex/adapter.json",
    "adapters/swe-rex/descriptor.json",
    "adapters/container-use/adapter.json",
    "adapters/container-use/descriptor.json",
    "adapters/openclaw/descriptor.json",
    "adapters/openhands/descriptor.json",
    "adapters/paperclip/descriptor.json",
    "adapters/acp/descriptor.json",
    ...
    "docs/15-upstream-independent/adoption-and-integration.md",
    "docs/15-upstream-independent/README.md",
    ...
    "docs/17-guided-adoption/faq.md",
    "docs/18-native-hosts/README.md",
    "docs/18-native-hosts/support-matrix.md",
    "docs/18-native-hosts/conversation-workflow.md",
    "docs/18-native-hosts/openclaw.md",
    "docs/18-native-hosts/hermes-agent.md",
    "docs/18-native-hosts/multica.md",
    ...
    "contracts/runner-candidates.json",
    "contracts/external-adapter-candidates.json",
    "acceptance/github-scm-first-run.json",
    "acceptance/github-scm-replay.json",
    "acceptance/v08-native-conformance.json",
    "hosts/claude/host.json",
    "hosts/codex/host.json",
    "hosts/generic-ai/host.json",
    "hosts/hermes/host.json",
    "hosts/multica/host.json",
    "hosts/openclaw/host.json",
    ...
    "examples/guided-adoption/README.md",
    "examples/guided-adoption/software-assisted.md",
    "examples/guided-adoption/managed-feedback.md",
    "examples/guided-adoption/knowledge-team.md",
    "skills/create-agent-team/SKILL.md",
    "skills/install-agent-team-host/SKILL.md",
    "skills/install-agent-team-host/agents/openai.yaml",
    ...
    ".agents/plugins/plugins/agent-team/skills/bootstrap-agent-team/references/conversation-workflow.md",
    ".agents/plugins/plugins/agent-team/skills/bootstrap-agent-team/references/scenarios-and-commands.md",
    ".agents/plugins/plugins/agent-team/skills/install-agent-team-host/SKILL.md",
    ".agents/plugins/plugins/agent-team/skills/install-agent-team-host/agents/openai.yaml",
